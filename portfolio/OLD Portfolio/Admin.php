...
<head>
    ...
    <link rel="stylesheet" href="Project Ready/css/bootstrap.min.css">
    <!-- Fav icon -->
...
<?php
    ...
    foreach ($result as $num => $name) {
        ...
        if ($num != 0 && $num != 1 && $name != '.ftpquota' && $name !='.gitattributes') {
...
<script src="Project Ready/js/jquery-3.3.1.min..js"></script>
